...
int show3DViewer(pcl::PointCloud<PointType>& point_cloud, Eigen::Affine3f scene_sensor_pose)
{
	// -----------------------------------------------
	// --------------为点云数据创建深度图像-----------
	// -----------------------------------------------
...
int show_range_image(pcl::RangeImage& range_image)
{
	// -----------------------------------------------
	// -----------------显示深度图像------------------
	// -----------------------------------------------
	...
	range_image_wiget.showRangeImage(range_image);
	range_image_wiget.spin();
	//--------------------
	// -----Main loop-----
	//--------------------
	while (!range_image_wiget.wasStopped())
	{
...
//主函数
int showrangeimagetest(int argc, char** argv)
{
	// ------------------------------------------------------------------
	// -----------------------命令行参数解析---------------------------
	// ------------------------------------------------------------------
	...
	// show3DViewer(point_cloud, scene_sensor_pose);
	
	show_range_image(range_image);
